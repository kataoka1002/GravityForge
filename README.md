...
> ![ひかく20](https://github.com/kataoka1002/GravityForge/assets/122655580/8fa6ff98-789d-4786-be22-c6f988a08ca3)
> ※大量の敵の描画
...
> #### ・30FPSを下回らなくなったものの、さらなる軽量化の為実装しました。<br /> ・カメラの視錐台の中に入っているもののみを描画することで計算量を削減しています。
> ![オクルージョンカリング](https://github.com/kataoka1002/GravityForge/assets/122655580/6af97c57-83d0-41ff-ad88-6c4f0c12f976)
> #### ・オブジェクトからカメラに向かってレイを飛ばし、その間に遮蔽物がある場合は描画をしないことで計算量の削減をしています。<br />・この2つのカリングを実装したことで、60FPSを出力することが出来ました。
> ![ひかく40](https://github.com/kataoka1002/GravityForge/assets/122655580/fd628995-749e-47e5-b9b6-b2b1f895c61e)
> ### ⑧ステートパターン
> #### ・前回作成したゲームでプレイヤーのクラスのコードが長すぎたので、もっと管理しやすいよう実装しました。<br /> ・状態を表すステートをクラスで用意しプレイヤーに入れ替えながら持たせることで、他状態の処理に影響を及ぼさないようにしています。
> ![ステートパターン](https://github.com/kataoka1002/GravityForge/assets/122655580/4337a275-9032-46b5-a1a3-a210a46dfec4)
